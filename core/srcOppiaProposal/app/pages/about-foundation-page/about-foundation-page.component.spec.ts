...
describe('About Foundation Component', () => {
  let fixture: ComponentFixture<AboutFoundationPageComponent>;
  let componentInstance: AboutFoundationPageComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AboutFoundationPageComponent);
