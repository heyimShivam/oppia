...
import { AfterViewInit, ChangeDetectorRef, Component, ComponentFactoryResolver, Input, OnChanges, SimpleChange, ViewChild, ViewContainerRef } from '@angular/core';
...
@Component({
  selector: 'value-generator-editor',
